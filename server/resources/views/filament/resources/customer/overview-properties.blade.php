        ...
        @forelse ($properties as $property)
            ...
            <div class="cov-row">
                ...
                <div class="cov-row-main">
                    ...
                    @if ($property->lawn_size || $property->square_footage)
                        <div class="cov-row-sub cov-num">
                            {{ collect([
                                $property->lawn_size ? $property->lawn_size . ' lawn' : null,
                                $property->square_footage ? number_format((float) $property->square_footage) . ' sq ft' : null,
                            ])->filter()->join(' · ') }}
                        </div>
                    @endif
                </div>
