<div>
    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 20px; gap: 16px; flex-wrap: wrap;">
        <div>
            <h2 style="font-size: 18px; font-weight: 700; color: #111827; margin: 0 0 4px 0;">Route Accessibility</h2>
            <p style="font-size: 13px; color: #6b7280; margin: 0;">
                Verifies that each core resource route is registered in the router.
