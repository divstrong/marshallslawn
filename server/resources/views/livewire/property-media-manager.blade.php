<div>
    ...
    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 16px;">
        <div>
            ...
            <p style="font-size: 13px; color: #6b7280; margin: 2px 0 0;">Photos, videos, and documents for this property</p>
        </div>
        <button
    ...
    @else
        <div style="text-align: center; padding: 48px 24px; background: #f9fafb; border: 2px dashed #e5e7eb; border-radius: 12px;">
            ...
            <p style="font-size: 14px; color: #6b7280; margin: 0;">No media uploaded yet</p>
        ...
        <div style="position: fixed; inset: 0; z-index: 50; display: flex; align-items: center; justify-content: center; padding: 16px;" onclick="if(event.target===this)$wire.closeUploadModal()">
            ...
            <div style="position: relative; background: #fff; border-radius: 16px; box-shadow: 0 25px 50px rgba(0,0,0,0.25); width: 100%; max-width: 520px; overflow: hidden;">
                <div style="padding: 20px 24px; border-bottom: 1px solid #e5e7eb; display: flex; justify-content: space-between; align-items: center;">
                    <h3 style="font-size: 16px; font-weight: 700; color: #111827; margin: 0;">Upload Media</h3>
                ...
                <div style="padding: 24px;">
                    <div style="border: 2px dashed #d1d5db; border-radius: 12px; padding: 32px; text-align: center; background: #f9fafb;">
                        <input type="file" wire:model="uploads" multiple accept="image/*,video/*,.pdf,.doc,.docx,.xls,.xlsx,.csv,.txt"
                               style="display: block; margin: 0 auto; font-size: 14px; color: #374151;" />
                        <p style="font-size: 12px; color: #9ca3af; margin-top: 8px;">Photos, videos, PDFs, and documents. Max 50MB per file.</p>
                    </div>
